...
export function MortgageCalculator({
  ...
  const monthly = useMemo(() => {
    return estimateMonthlyCost(homePrice, monthlyFee, interestRate / 100, years, operatingCost);
  }, [homePrice, monthlyFee, interestRate, years, operatingCost]);
  ...
  return (
    <section className="card space-y-4 p-5">
      ...
      <p className="text-sm text-[var(--muted)]">
        {pick(locale, { sv: "Pris", ar: "السعر", fi: "Hinta", bcs: "Cijena", en: "Price" })} {formatSEK(homePrice)} • {pick(locale, { sv: "Avgift", ar: "الرسوم", fi: "Maksu", bcs: "Naknada", en: "Fee" })} {formatSEK(monthlyFee)} • {pick(locale, { sv: "Drift", ar: "التشغيل", fi: "Käyttö", bcs: "Održavanje", en: "Operating" })} {formatSEK(operatingCost)}
      </p>
